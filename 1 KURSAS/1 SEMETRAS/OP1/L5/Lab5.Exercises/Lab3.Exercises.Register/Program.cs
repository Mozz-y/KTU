...
namespace Lab3.Exercises.Register
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            AnimalContainer animalContainer = InOutUtils.ReadAnimals("Dogs.csv");
            AnimalContainer shallowCopy = new AnimalContainer(animalContainer); // Backup of original data
            animalContainer.Sort(new AnimalsComparatorByName());
            Register register = new Register(animalContainer);
            ...
            Console.WriteLine("Iš viso šunų: {0}", register.AnimalCount());
            ...
            AnimalContainer filteredByBreed = register.FilterByBreed(selectedBreed);
            ...
            AnimalContainer expiredVaccinationsRegister = register.FilterByVaccinationExpired();
