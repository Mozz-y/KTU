...
namespace Lab3.Exercises.Register
{
    ...
    class Register
    {
        ...
        public Register(AnimalsContainer animalsContainer)
        {
            AllAnimals = animalsContainer;
        }
        ...
        {
            return FindOldestDog(AllAnimals); //////////////////////////////////////////////
        }
        ...
        {
            AnimalsContainer filtered = FilterByBreed(breed);
        ...
        private Animal FindOldestDog(AnimalsContainer animals)
        {
        ...
        {
            AnimalsContainer expiredVaccinationAnimals = new AnimalsContainer();
