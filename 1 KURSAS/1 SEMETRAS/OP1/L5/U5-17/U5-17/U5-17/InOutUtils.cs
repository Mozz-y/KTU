...
namespace U5_17
{
    ...
    public static class InOutUtils
    {
        ...
        /// </returns>
        public static Register ReadData(string filePath)
        {
            ...
            using (var reader = new StreamReader(filePath))
            {
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    switch (type)
                    {
                        ...
                        default:
                            throw new InvalidOperationException($"Nežinomas klausimo tipas: {type}");
                    }
                }
            }

            return new Register(organizationName, questions);
        }
